<template>
  <div>
    ...
    <!-- first block -->
    <div class="block">
      <div class="col-lg-12 inner background-para-1">
        <div class="col-lg-12">
          <h1 class="text-center"><strong>L'histoire du Canal</strong></h1>
          <br />
          <div class="col-lg-12 para-1">
            <div class="col-lg-2 illustration">
              <img src="../../static/pierrePaulRiquet.jpg" />
                <li>Pierre-Paul Riquet</li>
                <li>1748</li>
            </div>
            <div class="col-lg-10">
    ...
    <!-- second block -->
    <div class="block">
      <div class="col-lg-12 inner background-para-2">
        <div class="col-lg-12">
          <h1 class="text-center"><strong>les personnages clés</strong></h1>
          <br />
          <div class="col-lg-12 para-1">
            <!-- first illustration -->
            <div class="col-lg-3 para-3">
              <img src="../../static/pierrePaulRiquet.jpg" />
